...
PhonePlan::PhonePlan(int numMinutes, int numMessages){ // newly-created constructor wth parameters
   freeMinutes = numMinutes;                           // parameter set to equal constructor default
   freeMessages = numMessages;                         // parameter set to equal constructor default
   return;
}
